  ...
  <div v-if="rg" class="flex flex--column gap--regular">
    ...
    <LcCardContainer :border="true" padding="regular">
      ...
      <div class="grid grid--2-col grid--fluid gap--regular">
        ...
        <div class="flex flex--column gap--micro">
          ...
          >
          <span class="text--body text--neutral-900">{{
            rg.SITUATION_FAMILIALE || "–"
          }}</span>
        </div>
        <div class="flex flex--column gap--micro">
          <span class="text--caption-semibold text--neutral-600"
            >Situation Carcept</span
          >
          <span class="text--body text--neutral-900">{{
            rg.SITUATION_CARCEPT || "–"
          }}</span>
        </div>
        <div class="flex flex--column gap--micro">
        ...
        <div class="flex flex--column gap--micro">
          <span class="text--caption-semibold text--neutral-600"
            >Référence assureur</span
          >
          <span class="text--body text--neutral-900">{{
            rg.REFRENCE_ASSUREUR || "–"
          }}</span>
        </div>
        <div class="flex flex--column gap--micro">
          <span class="text--caption-semibold text--neutral-600"
    ...
    >
      ...
      <div class="flex flex--column gap--small">
        <div
          v-for="(etat, index) in etatsHistorique"
          :key="index"
          class="flex flex--align-center gap--medium"
        >
