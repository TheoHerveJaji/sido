<template>
  ...
  >
    ...
    <div v-else-if="benef" class="modal-content flex flex--column gap--medium">
      <div class="flex flex--justify-between flex--align-center px--regular">
      ...
      <!-- ── Signalétique ── -->
      <div
        class="flex flex--column gap--medium p--regular bg--neutral-100 radius"
      >
        ...
        <div class="grid grid--2-col grid--fluid gap--regular">
          ...
          <div class="flex flex--column gap--micro">
            ...
            <span class="text--body text--neutral-900">
              {{
                [
                  benef.ADRESSE1_BENEF,
                  benef.ADRESSE2_BENEF,
                  benef.ADRESSE3_BENEF,
                ]
                  .filter(Boolean)
                  .join(", ")
              }}
              ...
              {{
                [benef.CODE_POSTAL_BENEF, benef.VILLE_BENEF]
                  .filter(Boolean)
                  .join(" ")
              }}
            </span>
      ...
      >
        ...
        <div class="grid grid--3-col grid--fluid gap--regular">
          <div class="flex flex--column gap--micro">
            ...
            <span class="text--body text--neutral-900">
              {{ formatCurrency(benef.CAPITAL_BENEF) }}
            </span>
          </div>
          <div class="flex flex--column gap--micro">
            <span class="text--caption-semibold text--neutral-600">
            ...
            <span class="text--body text--neutral-900">
              {{ formatCurrency(benef.DESTINATAIRE_BENEF) }}
            </span>
          </div>
          <div class="flex flex--column gap--micro">
            <span class="text--caption-semibold text--neutral-600">
            ...
            <span class="text--body text--neutral-900">
              {{ formatCurrency(benef.ENFANT_BENEF) }}
            </span>
          </div>
          <div class="flex flex--column gap--micro">
            <span class="text--caption-semibold text--neutral-600">
            ...
            <span class="text--body text--neutral-900">
              {{ formatDate(benef.DATE_CAPITAL_BENEF) }}
            </span>
          </div>
          <div class="flex flex--column gap--micro">
            <span class="text--caption-semibold text--neutral-600">
      ...
      >
        ...
        <div class="grid grid--3-col grid--fluid gap--regular">
          <div class="flex flex--column gap--micro">
            ...
            <span class="text--body text--neutral-900">
              {{ formatCurrency(benef.COMPLEMENT_BENEF) }}
            </span>
          </div>
          <div class="flex flex--column gap--micro">
            <span class="text--caption-semibold text--neutral-600">
            ...
            <span class="text--body text--neutral-900">
              {{ formatCurrency(benef.DESTINATAIRE_COMPL_BENEF) }}
            </span>
          </div>
          <div class="flex flex--column gap--micro">
            <span class="text--caption-semibold text--neutral-600">
            ...
            <span class="text--body text--neutral-900">
              {{ formatCurrency(benef.ENFANT_COMPL_BENEF) }}
            </span>
          </div>
          <div class="flex flex--column gap--micro">
            <span class="text--caption-semibold text--neutral-600">
            ...
            <span class="text--body text--neutral-900">
              {{ formatDate(benef.DATE_COMPL_BENEF) }}
            </span>
          </div>
        </div>
      </div>
